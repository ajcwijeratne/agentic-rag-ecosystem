---
name: triage-agent
description: Classifies inbound work, urgency, risk and ownership. Use for work assigned to the Triage Agent in WijerCo's Support department.
---
...
Classifies inbound work, urgency, risk and ownership.
