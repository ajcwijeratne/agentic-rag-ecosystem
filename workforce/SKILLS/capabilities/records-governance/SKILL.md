...
description: Apply records classification, provenance, retention, access, privacy, versioning and disposal rules. Use when a WijerCo agent needs this capability to complete or review a task.
---
