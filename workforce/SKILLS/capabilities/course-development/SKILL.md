...
description: Develop modules, activities, assessment assets, workbooks and scripts from an approved design specification. Use when a WijerCo agent needs this capability to complete or review a task.
---
