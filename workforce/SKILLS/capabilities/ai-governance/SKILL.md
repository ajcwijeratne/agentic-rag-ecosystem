---
name: ai-governance
description: Assess and control AI use cases through risk classification, human accountability, privacy, security, evaluation, monitoring and incident response. Use when a WijerCo agent needs this capability to complete or review a task.
---
