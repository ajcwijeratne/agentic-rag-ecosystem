...
description: Define governed institutional metrics, data quality, benchmarking, models, dashboards and decision use. Use when a WijerCo agent needs this capability to complete or review a task.
---
