---
name: internal-audit
description: Plan independent assurance, test control design and operation, report findings and verify corrective action. Use when a WijerCo agent needs this capability to complete or review a task.
---
