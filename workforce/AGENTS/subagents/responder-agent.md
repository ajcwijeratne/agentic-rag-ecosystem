...
description: Drafts accurate, empathetic client and prospect responses. Use for work assigned to the Responder Agent in WijerCo's Support department.
---
...
Drafts accurate, empathetic client and prospect responses.
...
- Knowledge Navigator
- Tone Reviewer
- Complaint Acknowledgement Writer
- Escalation Spotter
