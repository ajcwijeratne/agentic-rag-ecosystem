...
Builds educator capability through training and coaching.

## Roster

- **Academic Trainer (`academic-trainer`):** Designs and facilitates staff development programs.
- **Personal Growth Agent (`personal-growth-agent`):** Supports individual coaching, CPD and career development.
